  ...
  <div className="extras">
    <div className="extras__container">
      ...
      <section className="extras__section extras__contacts">
        <h2 className="extras__title">Контакты</h2>

        <div className="extras__contacts-body">
          <div className="extras__contacts-block">
            <h3 className="extras__contacts-title">Автор проекта</h3>
            <p className="extras__contacts-name">Елена Семенова</p>
            <ul className="extras__contacts-list">
              <li>Телефон: <a href="tel:+79169601863">+7 916 960 1863</a></li>
              <li>Telegram: <a href="https://t.me/SemenovaElena" target="_blank" rel="noopener noreferrer">@SemenovaElena</a></li>
          ...
          <div className="extras__contacts-block">
            <h3 className="extras__contacts-title">Администратор проекта</h3>
            <p className="extras__contacts-name">Сергей Ковальчук</p>
            <ul className="extras__contacts-list">
              <li>Телефон: <a href="tel:+79657536693">+7 965 753 6693</a></li>
              <li>Telegram: <a href="https://t.me/smkovalchuk" target="_blank" rel="noopener noreferrer">@smkovalchuk</a></li>
            </ul>
          </div>

          <div className="extras__contacts-block">
            <h3 className="extras__contacts-title">Проект AI4G</h3>
            <ul className="extras__contacts-list">
              <li>Сайт: <a href="https://ai4g.ru" target="_blank" rel="noopener noreferrer">ai4g.ru</a></li>
              <li>Email: <a href="mailto:info@ai4g.ru">info@ai4g.ru</a></li>
              <li>Telegram-канал: <a href="https://t.me/life_watch" target="_blank" rel="noopener noreferrer">@life_watch</a></li>
            </ul>
          </div>
        </div>
      </section>
